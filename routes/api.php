...
Route::get('/game-data/all-heroes', function () {
    ...
    $hardcodedHeroes = [
        ['name' => 'Iron Man', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/iron_man.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Hard'],
        ['name' => 'Spider-Man', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/spider_man.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Black Widow', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/black_widow.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Easy'],
        ['name' => 'Hawkeye', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/hawkeye.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Star-Lord', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/star-lord.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Punisher', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/punisher.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Easy'],
        ['name' => 'Winter Soldier', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/winter_soldier.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Squirrel Girl', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/squirrel_girl.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Hulk', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/hulk.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Easy'],
        ['name' => 'Thor', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/thor.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ['name' => 'Groot', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/groot.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Medium'],
        ['name' => 'Doctor Strange', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/doctor_strange.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Hard'],
        ['name' => 'Magneto', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/magneto.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ['name' => 'Captain America', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/captain_america.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Easy'],
        ['name' => 'Venom', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/venom.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Medium'],
        ['name' => 'Storm', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/storm.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Medium'],
        ['name' => 'Mantis', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/mantis.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Medium'],
        ['name' => 'Rocket Raccoon', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/rocket_raccoon.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Luna Snow', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/luna_snow.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Medium'],
        ['name' => 'Adam Warlock', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/adam_warlock.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Hard'],
        ['name' => 'Cloak & Dagger', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/cloak_dagger.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Hard'],
        ['name' => 'Jeff the Land Shark', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/jeff_the_land_shark.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Easy'],
        ['name' => 'Wolverine', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/wolverine.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Easy'],
        ['name' => 'Invisible Woman', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/invisible_woman.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Medium'],
        ['name' => 'Moon Knight', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/moon_knight.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Deadpool', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/deadpool.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Cyclops', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/cyclops.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Daredevil', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/daredevil.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Gambit', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/gambit.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Ghost Rider', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/ghost_rider.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Hard'],
        ['name' => 'Professor X', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/professor_x.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Hard'],
        ['name' => 'Shuri', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/shuri.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Medium'],
        ['name' => 'Falcon', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/falcon.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Silver Surfer', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/silver_surfer.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Hard'],
        ['name' => 'Doctor Doom', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/doctor_doom.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ['name' => 'Thanos', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/thanos.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ['name' => 'Galactus', 'role' => 'Tank', 'type' => 'Tank', 'image' => '/storage/heroes/galactus.webp', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ['name' => 'Phoenix', 'role' => 'Support', 'type' => 'Support', 'image' => '/storage/heroes/phoenix.webp', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Hard'],
        ['name' => 'Mystique', 'role' => 'DPS', 'type' => 'DPS', 'image' => '/storage/heroes/mystique.webp', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium']
    ];
...
// Add CORS headers to a commonly tested endpoint
// Add CORS headers to the exact endpoint the test checks
...
Route::get('/matches/{matchId}/scoreboard', function (Request $request, $matchId) {
    try {
        ...
        // Get match statistics for players from correct table
        $matchStats = [];
        try {
            $matchStats = DB::table('player_match_stats')
                ...
                ->where('player_match_stats.match_id', $matchId)
                ->get()
                ->groupBy('team_id');
        } catch (\Exception $e) {
...
// ==========================================
// LIVE SCORING ADMIN ENDPOINTS - REAL-TIME UPDATES
// ==========================================

// Update Match Status (Live/Upcoming/Completed)
...
// Update Team Composition (Heroes) for Live Match
Route::middleware(['auth:sanctum', 'role:admin|moderator'])->put('/admin/matches/{id}/team-composition', function (Request $request, $id) {
    try {
        $validated = $request->validate([
            'map_index' => 'required|integer|min:0',
            'team1_composition' => 'sometimes|array',
            'team1_composition.*.player_id' => 'required_with:team1_composition|integer',
            'team1_composition.*.hero' => 'required_with:team1_composition|string',
            'team1_composition.*.role' => 'required_with:team1_composition|string',
            'team2_composition' => 'sometimes|array',
            'team2_composition.*.player_id' => 'required_with:team2_composition|integer',
            'team2_composition.*.hero' => 'required_with:team2_composition|string',
        ...
        return response()->json([
            ...
            'data' => ['map_index' => $mapIndex, 'updated_compositions' => $validated]
        ]);
...
// Update Current Map and Mode
Route::middleware(['auth:sanctum', 'role:admin|moderator'])->put('/admin/matches/{id}/current-map', function (Request $request, $id) {
    try {
        $validated = $request->validate([
            'current_map' => 'required|string',
            'current_mode' => 'sometimes|string',
            'map_index' => 'sometimes|integer|min:0'
        ]);
...
// Update Match Timer/Duration
Route::middleware(['auth:sanctum', 'role:admin|moderator'])->put('/admin/matches/{id}/timer', function (Request $request, $id) {
    try {
        $validated = $request->validate([
            'action' => 'required|string|in:start,pause,resume,stop,sync',
            'elapsed_time' => 'sometimes|integer|min:0', // seconds
            'round_time' => 'sometimes|integer|min:0',
            'phase' => 'sometimes|string|in:warmup,round,overtime,break'
        ]);
        
        // Store timer state in a JSON field or separate table
        $timerData = [
            'action' => $validated['action'],
            'elapsed_time' => $validated['elapsed_time'] ?? 0,
            'round_time' => $validated['round_time'] ?? 0,
            'phase' => $validated['phase'] ?? 'round',
            'timestamp' => now()->toISOString(),
            'updated_at' => now()
        ];
        
        // For now, store in matches table - could be moved to separate match_timer table
        DB::table('matches')->where('id', $id)->update([
            'timer_data' => json_encode($timerData),
            'updated_at' => now()
        ]);
...
// Get Complete Live State for Admin Dashboard
Route::middleware(['auth:sanctum', 'role:admin|moderator'])->get('/admin/matches/{id}/live-state', function (Request $request, $id) {
    try {
        ...
        $match = DB::table('matches as m')
            ...
            ->select([
                'm.*',
                't1.name as team1_name', 't1.logo as team1_logo', 't1.flag as team1_flag',
                't2.name as team2_name', 't2.logo as team2_logo', 't2.flag as team2_flag',
                'e.name as event_name', 'e.type as event_type'
            ])
            ->where('m.id', $id)
            ->first();
        ...
        // Get team players with current stats
        $team1Players = DB::table('players')
            ->select(['id', 'name', 'username', 'role', 'main_hero', 'avatar', 'country'])
            ->where('team_id', $match->team1_id)
            ->get();
        ...
        $liveState = [
            'match' => [
                ...
                'format' => $match->format,
                'timer_data' => $match->timer_data ?? null,
                'viewers' => $match->viewers ?? 0,
        ...
        return response()->json([
            'success' => false,
            'message' => 'Error fetching live state: ' . $e->getMessage()
        ], 500);
    }
});
...
// ==========================================
// NOTE: Duplicate scoreboard route removed - using the one at line 2492 instead
