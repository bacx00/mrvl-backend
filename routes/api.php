...
// CORS Options Routes - MUST be exact pattern match
...
// Additional patterns to catch different URL formats
Route::options('/teams', function () {
    return response('', 200)
        ->header('Access-Control-Allow-Origin', '*')
        ->header('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS')
...
Route::get('/game-data/all-heroes', function () {
    ...
    $hardcodedHeroes = [
        ['name' => 'Iron Man', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Hard'],
        ['name' => 'Spider-Man', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ...
        ['name' => 'Thor', 'role' => 'Vanguard', 'type' => 'Tank', 'image' => '', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ...
        ['name' => 'Storm', 'role' => 'Strategist', 'type' => 'Support', 'image' => '', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Medium'],
        ...
        ['name' => 'Rocket Raccoon', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ...
        ['name' => 'Deadpool', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Cyclops', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Daredevil', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Gambit', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Ghost Rider', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Hard'],
        ['name' => 'Professor X', 'role' => 'Strategist', 'type' => 'Support', 'image' => '', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Hard'],
        ['name' => 'Shuri', 'role' => 'Support', 'type' => 'Support', 'image' => '', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Medium'],
        ['name' => 'Falcon', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Medium'],
        ['name' => 'Silver Surfer', 'role' => 'Duelist', 'type' => 'DPS', 'image' => '', 'abilities' => '{"primary":"Strike Attack","secondary":"Rapid Fire","ultimate":"Combat Rush"}', 'description' => 'A damage-focused fighter specializing in eliminating enemies and high-impact plays.', 'difficulty' => 'Hard'],
        ['name' => 'Doctor Doom', 'role' => 'Vanguard', 'type' => 'Tank', 'image' => '', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ['name' => 'Thanos', 'role' => 'Tank', 'type' => 'Tank', 'image' => '', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ['name' => 'Galactus', 'role' => 'Tank', 'type' => 'Tank', 'image' => '', 'abilities' => '{"primary":"Shield Slam","secondary":"Defensive Stance","ultimate":"Guardian Shield"}', 'description' => 'A frontline defender who excels at protecting teammates and controlling battlefield positioning.', 'difficulty' => 'Hard'],
        ['name' => 'Phoenix', 'role' => 'Strategist', 'type' => 'Support', 'image' => '', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Hard'],
        ...
        ['name' => 'Scarlet Witch', 'role' => 'Strategist', 'type' => 'Support', 'image' => '', 'abilities' => '{"primary":"Heal Beam","secondary":"Support Aura","ultimate":"Team Boost"}', 'description' => 'A support specialist who enhances team capabilities and provides tactical advantages.', 'difficulty' => 'Hard']
    ];
...
// Commented out to avoid conflict with custom auth route below that handles 401 properly
