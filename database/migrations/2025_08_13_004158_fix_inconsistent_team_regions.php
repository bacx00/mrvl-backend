...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Fix inconsistent team regions to match Marvel Rivals official tournament structure
     */
    public function up(): void
    {
        ...
        // Update each region mapping
        foreach ($regionMappings as $oldRegion => $newRegion) {
            DB::table('teams')->where('region', $oldRegion)->update(['region' => $newRegion]);
        }

        // Log the changes for audit purposes
        \Log::info('Team regions standardized to Marvel Rivals official structure', [
            'mappings_applied' => $regionMappings,
            'migration' => '2025_08_13_004158_fix_inconsistent_team_regions'
        ]);
    }
    ...
    public function down(): void
    {
        ...
        \Log::warning('Attempted to rollback region standardization migration - no action taken', [
            'migration' => '2025_08_13_004158_fix_inconsistent_team_regions'
        ]);
    }
};