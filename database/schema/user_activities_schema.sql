...
CREATE TABLE `bracket_games` (
  ...
  `map_type` enum('control','escort','hybrid','flashpoint','push') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `bracket_games_bracket_match_id_game_number_unique` (`bracket_match_id`,`game_number`),
  KEY `bracket_games_winner_id_foreign` (`winner_id`),
  KEY `bracket_games_bracket_match_id_winner_id_index` (`bracket_match_id`,`winner_id`),
...
CREATE TABLE `bracket_matches` (
  ...
  `team1_source` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team2_source` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `team1_score` int NOT NULL DEFAULT '0',
  `team2_score` int NOT NULL DEFAULT '0',
  `winner_id` bigint unsigned DEFAULT NULL,
  `loser_id` bigint unsigned DEFAULT NULL,
  `best_of` enum('1','3','5','7') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '3',
  `status` enum('pending','ready','live','completed','forfeit','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `scheduled_at` timestamp NULL DEFAULT NULL,
  `started_at` timestamp NULL DEFAULT NULL,
  `completed_at` timestamp NULL DEFAULT NULL,
  `winner_advances_to` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `loser_advances_to` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vods` json DEFAULT NULL,
  `interviews` json DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `bracket_reset` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `bracket_matches_bracket_stage_id_round_number_match_number_index` (`bracket_stage_id`,`round_number`,`match_number`),
  KEY `bracket_matches_tournament_id_status_index` (`tournament_id`,`status`),
  KEY `bracket_matches_event_id_status_index` (`event_id`,`status`),
  KEY `bracket_matches_winner_advances_to_index` (`winner_advances_to`),
  KEY `bracket_matches_loser_advances_to_index` (`loser_advances_to`),
  ...
  CONSTRAINT `bracket_matches_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `bracket_positions` (
  ...
  KEY `bracket_positions_bracket_stage_id_foreign` (`bracket_stage_id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `bracket_seedings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bracket_seedings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tournament_id` bigint unsigned DEFAULT NULL,
  `event_id` bigint unsigned DEFAULT NULL,
  `bracket_stage_id` bigint unsigned NOT NULL,
  ...
  `seeding_method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  `seeding_data` json DEFAULT NULL,
  `seeded_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `bracket_seedings_bracket_stage_id_seed_unique` (`bracket_stage_id`,`seed`),
  UNIQUE KEY `bracket_seedings_bracket_stage_id_team_id_unique` (`bracket_stage_id`,`team_id`),
  KEY `bracket_seedings_team_id_foreign` (`team_id`),
  KEY `bracket_seedings_tournament_id_seed_index` (`tournament_id`,`seed`),
  KEY `bracket_seedings_event_id_seed_index` (`event_id`,`seed`),
  CONSTRAINT `bracket_seedings_bracket_stage_id_foreign` FOREIGN KEY (`bracket_stage_id`) REFERENCES `bracket_stages` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bracket_seedings_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bracket_seedings_team_id_foreign` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bracket_seedings_tournament_id_foreign` FOREIGN KEY (`tournament_id`) REFERENCES `tournaments` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bracket_stages` (
  ...
  `type` enum('upper_bracket','lower_bracket','swiss','round_robin','group_stage','third_place','grand_final') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'upper_bracket',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bracket_stages_tournament_id_type_stage_order_index` (`tournament_id`,`type`,`stage_order`),
  KEY `bracket_stages_event_id_type_stage_order_index` (`event_id`,`type`,`stage_order`),
  CONSTRAINT `bracket_stages_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bracket_stages_tournament_id_foreign` FOREIGN KEY (`tournament_id`) REFERENCES `tournaments` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `bracket_standings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bracket_standings` (
  ...
  `placement_range` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `swiss_score` decimal(4,2) DEFAULT NULL,
  `buchholz_score` int DEFAULT NULL,
  `placement_data` json DEFAULT NULL,
  `eliminated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `bracket_standings_tournament_id_team_id_unique` (`tournament_id`,`team_id`),
  UNIQUE KEY `bracket_standings_event_id_team_id_unique` (`event_id`,`team_id`),
  KEY `bracket_standings_team_id_foreign` (`team_id`),
  KEY `bracket_standings_final_placement_index` (`final_placement`),
  CONSTRAINT `bracket_standings_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bracket_standings_team_id_foreign` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bracket_standings_tournament_id_foreign` FOREIGN KEY (`tournament_id`) REFERENCES `tournaments` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `earnings_history` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `earnable_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `type` enum('tournament_prize','match_reward','sponsorship','adjustment') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `elo_history` (
  ...
  `match_id` bigint unsigned DEFAULT NULL,
  `change_reason` enum('match_win','match_loss','tournament_bonus','inactivity_decay','manual_adjustment') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `forum_posts` (
  ...
  KEY `idx_forum_posts_user_created` (`user_id`,`created_at`),
...
CREATE TABLE `forum_reports` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `reportable_type` enum('forum_thread','forum_post') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `forum_threads` (
  ...
  KEY `idx_forum_threads_user_created` (`user_id`,`created_at`),
...
CREATE TABLE `forum_votes` (
  ...
  `vote_type` enum('upvote','downvote') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vote_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `marvel_rivals_heroes` (
  ...
  KEY `idx_heroes_role_name` (`role`,`name`),
  KEY `idx_heroes_active_sort` (`active`,`sort_order`),
  KEY `marvel_rivals_heroes_created_by_foreign` (`created_by`),
  KEY `marvel_rivals_heroes_updated_by_foreign` (`updated_by`),
  CONSTRAINT `marvel_rivals_heroes_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `marvel_rivals_heroes_updated_by_foreign` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `chk_heroes_name_length` CHECK (((char_length(`name`) >= 2) and (char_length(`name`) <= 100))),
  CONSTRAINT `chk_heroes_role_values` CHECK ((`role` in (_utf8mb4'Vanguard',_utf8mb4'Duelist',_utf8mb4'Strategist')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `match_comments` (
  ...
  KEY `idx_match_comments_user_created` (`user_id`,`created_at`),
  KEY `idx_match_comments_match_created` (`match_id`,`created_at`),
...
CREATE TABLE `match_maps` (
  ...
  `capture_progress` json DEFAULT NULL,
  `payload_distance` decimal(5,2) DEFAULT NULL,
  `team1_composition` json DEFAULT NULL,
  `team2_composition` json DEFAULT NULL,
  `hero_swaps` json DEFAULT NULL,
  `live_events` json DEFAULT NULL,
  ...
  KEY `idx_match_maps_match_num` (`match_id`,`map_number`),
  KEY `idx_match_maps_match_status` (`match_id`,`status`),
  KEY `idx_match_maps_status_time` (`status`,`started_at`),
...
CREATE TABLE `match_player_stats` (
  ...
  KEY `idx_match_player_stats_player_match` (`player_id`,`match_id`),
  KEY `idx_match_player_stats_player_hero` (`player_id`,`hero`),
...
CREATE TABLE `match_results_cache` (
  ...
  `team_id` bigint unsigned NOT NULL,
  `player_id` bigint unsigned DEFAULT NULL,
  `result` enum('win','loss') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `matches` (
  ...
  `started_at` timestamp NULL DEFAULT NULL,
  `ended_at` timestamp NULL DEFAULT NULL,
  `status` enum('upcoming','live','completed','cancelled','pending','scheduled','paused') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'upcoming',
  ...
  `team2_score` int NOT NULL DEFAULT '0',
  `maps_won_team1` int NOT NULL DEFAULT '0',
  `maps_won_team2` int NOT NULL DEFAULT '0',
  ...
  `current_map_status` enum('upcoming','live','completed','paused') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'upcoming',
  PRIMARY KEY (`id`),
  ...
  KEY `matches_match_format_series_completed_index` (`series_completed`),
  ...
  KEY `idx_matches_status_scheduled` (`status`,`scheduled_at`),
  KEY `idx_matches_event_status` (`event_id`,`status`),
  KEY `idx_matches_teams` (`team1_id`,`team2_id`),
  KEY `idx_matches_score` (`maps_won_team1`,`maps_won_team2`),
...
CREATE TABLE `mentions` (
  ...
  KEY `idx_mentions_mentioned_type_id` (`mentioned_type`,`mentioned_id`),
  KEY `idx_mentions_mentionable_type_id` (`mentionable_type`,`mentionable_id`),
  KEY `idx_mentions_mentioned_at` (`mentioned_at`),
  KEY `idx_mentions_mentioned_by` (`mentioned_by`,`created_at`),
  KEY `idx_mentions_mentioned_to` (`mentioned_type`,`mentioned_id`),
...
CREATE TABLE `news` (
  ...
  `videos` json DEFAULT NULL COMMENT 'JSON array of video embeds',
  `category` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general',
  `category_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `news_comments` (
  ...
  KEY `idx_news_comments_news_created` (`news_id`,`created_at`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `news_video_embeds`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `news_video_embeds` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `news_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `news_video_embeds_news_id_platform_index` (`news_id`,`platform`),
  CONSTRAINT `news_video_embeds_news_id_foreign` FOREIGN KEY (`news_id`) REFERENCES `news` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_team_history` (
  ...
  `change_type` enum('join','leave','transfer','transferred','promotion','demotion','joined','left','released','retired','loan_start','loan_end') COLLATE utf8mb4_unicode_ci DEFAULT 'join',
  `reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  KEY `idx_player_team_history_player_id` (`player_id`,`change_date`),
  KEY `idx_player_team_history_teams` (`from_team_id`,`to_team_id`),
...
CREATE TABLE `players` (
  ...
  `team_position` enum('player','coach','assistant_coach','manager','analyst','bench','inactive','substitute','captain','sub') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'player',
  ...
  `earnings_currency` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD',
  ...
  `most_played_hero` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `best_winrate_hero` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `team_rankings` (
  ...
  `ranking_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'overall',
...
CREATE TABLE `teams` (
  ...
  `current_streak_type` enum('win','loss','none') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `points` int NOT NULL DEFAULT '0',
  ...
  `coach_image` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  KEY `idx_teams_region_name` (`region`,`name`),
  ...
  CONSTRAINT `chk_teams_name_length` CHECK (((char_length(`name`) >= 2) and (char_length(`name`) <= 100))),
  CONSTRAINT `chk_teams_rating_range` CHECK (((`rating` >= 0) and (`rating` <= 5000))),
  CONSTRAINT `chk_teams_short_name_length` CHECK (((char_length(`short_name`) >= 1) and (char_length(`short_name`) <= 10)))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tournament_participants` (
  ...
  `team_id` bigint unsigned NOT NULL,
  `seed` int DEFAULT NULL,
  `status` enum('registered','confirmed','withdrawn','disqualified') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'registered',
  `registered_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user_activities` (
  ...
  KEY `user_activities_resource_type_resource_id_index` (`resource_type`,`resource_id`),
...
CREATE TABLE `users` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `role` enum('user','moderator','admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user' COMMENT 'User role: user, moderator, admin',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_users_hero_flair` (`hero_flair`),
  KEY `idx_users_profile_lookup` (`team_flair_id`,`hero_flair`,`status`),
  KEY `idx_users_avatar_type` (`use_hero_as_avatar`,`hero_flair`),
  KEY `idx_users_flair_display` (`show_hero_flair`,`show_team_flair`),
  ...
  CONSTRAINT `users_team_flair_id_foreign` FOREIGN KEY (`team_flair_id`) REFERENCES `teams` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ...
  CONSTRAINT `chk_users_hero_flair_length` CHECK ((char_length(`hero_flair`) <= 100)),
  CONSTRAINT `chk_users_status_values` CHECK ((`status` in (_utf8mb4'active',_utf8mb4'inactive',_utf8mb4'banned')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `votes` (
  ...
  KEY `idx_votes_user_created` (`user_id`,`created_at`),
  KEY `idx_votes_voteable` (`voteable_type`,`voteable_id`,`vote`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (157,'2025_08_06_fix_critical_database_schema_issues_final',113);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (158,'2025_08_06_200000_fix_news_categories_schema_and_seed_data',114);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (161,'2025_08_06_220000_fix_database_schema_carefully',115);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (162,'2025_08_06_231552_add_videos_column_to_news_table',116);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (164,'2025_08_07_000000_optimize_match_data_structure',117);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (165,'2025_08_06_231633_create_news_video_embeds_table',118);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (166,'2025_08_06_233417_add_paused_status_to_matches_table',118);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (167,'2025_08_07_120000_optimize_profile_performance_indexes',119);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (168,'2025_08_07_130000_add_data_integrity_constraints',120);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (170,'2025_08_07_000001_create_unified_votes_table',121);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (172,'2025_08_07_000002_create_user_activities_table',122);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (173,'2025_08_07_150000_add_role_enum_to_users_table',123);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (176,'2025_08_07_140000_create_comprehensive_bracket_system',124);
