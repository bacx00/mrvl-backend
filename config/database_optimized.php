...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION', 'mysql'), // Changed from sqlite for production
    ...
    */
    ...
    'connections' => [
        ...
        // Optimized MySQL read replica connection (if available)
        'mysql_read' => [
            'driver' => 'mysql',
            'url' => env('DB_READ_URL'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Redis is configured for high-performance caching when available.
    | Falls back to database cache when Redis is not available.
    |
    */
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'serializer' => 'php', // Use PHP serialization for better performance
        ],
    ...
    */
    ...
    'query_log' => [
        ...
        'log_channel' => env('DB_LOG_CHANNEL', 'database'),
    ],
